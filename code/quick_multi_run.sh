...
python3 train.py --training_type multi-task --epochs 10 --seed 0 -v --norm l1 --reg_lambda 0
python3 train.py --training_type multi-task --epochs 10 --seed 0 -v --norm l1 --reg_lambda 1e-7
python3 train.py --training_type multi-task --epochs 10 --seed 0 -v --norm l1 --reg_lambda 1e-6
python3 train.py --training_type multi-task --epochs 10 --seed 0 -v --norm l1 --reg_lambda 1e-5
python3 train.py --training_type multi-task --epochs 10 --seed 0 -v --norm l1 --reg_lambda 1e-4