...
python3 train.py --training_type multi-task --kernel_size 3 --epochs 10 --seed 0 --norm l1 --reg_lambda 1e-1 -v
python3 train.py --training_type multi-task --kernel_size 3 --epochs 10 --seed 0 --norm l1 --reg_lambda 1e-2 -v
python3 train.py --training_type multi-task --kernel_size 3 --epochs 10 --seed 0 --norm l1 --reg_lambda 1e-3 -v
python3 train.py --training_type multi-task --kernel_size 3 --epochs 10 --seed 0 --norm l1 --reg_lambda 1e-4 -v
python3 train.py --training_type multi-task --kernel_size 3 --epochs 10 --seed 0 --norm l1 --reg_lambda 1e-5 -v
